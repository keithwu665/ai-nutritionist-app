  ...
  saveAutofilledItem: protectedProcedure
    ...
    .mutation(async ({ input, ctx }: any) => {
      ...
      const result = await database.insert(foodLogItems).values({
        ...
        aiSuggestedKcal: input.aiSuggestedKcal,
        aiSuggestedProteinG: input.aiSuggestedProtein_g,
        aiSuggestedCarbsG: input.aiSuggestedCarbs_g,
        aiSuggestedFatG: input.aiSuggestedFat_g,
        aiConfidenceJson: input.aiConfidenceJson,
        aiPrefillJson: input.aiPrefillJson,
        isAiAutofilled: 1,
        isAutofilled: 1,
      });
