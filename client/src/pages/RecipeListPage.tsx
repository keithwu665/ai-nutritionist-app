...
const recipesByProtein: Record<string, Array<{ id: string; name: string; kcal: number; time: string }>> = {
  ...
  pork: [
    { id: 'p1', name: '香煎瘦豬肉蛋白碗', kcal: 310, time: '15分鐘' },
    { id: 'p2', name: '豬里肌牛油果吐司', kcal: 360, time: '12分鐘' },
    { id: 'p3', name: '瘦肉菠菜蛋白炒', kcal: 300, time: '14分鐘' },
    { id: 'p4', name: '豬肉番茄早餐碗', kcal: 330, time: '16分鐘' },
    { id: 'p5', name: '豬肉生菜卷', kcal: 280, time: '10分鐘' },
    { id: 'p6', name: '瘦肉粟米蛋白粥', kcal: 320, time: '18分鐘' },
    { id: 'p7', name: '豬肉藜麥早餐碗', kcal: 350, time: '16分鐘' },
    { id: 'p8', name: '豬肉蘑菇炒蛋白', kcal: 310, time: '14分鐘' },
    { id: 'p9', name: '豬肉全麥三文治', kcal: 340, time: '12分鐘' },
    { id: 'p10', name: '豬肉青瓜乳酪碗', kcal: 290, time: '10分鐘' },
  ],
  beef: [
